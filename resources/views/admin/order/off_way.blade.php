                                   ...
                                   <td>{{$order->total_amount}}</td>
                                    <td>
                                        @if(Auth::user()->action_process == 1)
                                            @if ($order->status == 'off_way')
                                            <a href="{{route('offer.wayProcess',$order->id)}}" onclick="way({{$order->id}})" class="btn btn-edit procesing" data-bs-toggle="modal" data-bs-target="#myModal">On the way</a>
                                            @endif
                                        @endif
                                    </td>
