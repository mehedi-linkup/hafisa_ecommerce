...
class PagesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $pages_order = [
            ...
            'order.offer.pending'  => 'Offer Pending',
            'offer.onProcess'      => 'Offer OnProcess',
            'offer.way'            => 'Offer on the way',
            'offer.way'            => 'Offer on the way',
            'waiting.delivered'    => 'Waiting Delivered',
        ...
        $pages_setting = [
            ...
            'action.permission'   => 'Create Edit Delete View Permission',
