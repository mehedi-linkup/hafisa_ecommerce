...
class ApiController extends Controller
{
    ...
    //                $customer_id = 'c-0001';
    //             //    $msg = "নতুন একটি অর্ডার করেছেন {$name} .গ্রাহকা আইডি  {$customer_id}";
                 
    //             //    $message = "প্রিয় {$name}, \n সফল ভাবে আপনার অর্ডারটি সম্পন্ন হয়েছ, আপনার অর্ডার নাম্বার {$invoice_no}";
        ...
        $rules=array(
            ...
            try 
            {
                ...
                foreach ($cart as $value) {
                   ...
                   $name = $request->customer_name ;
                   $customer_id = 'c-0001';
                   $msg = "নতুন একটি অর্ডার করেছেন $name .গ্রাহকা আইডি  $invoice_no";
